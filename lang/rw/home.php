...
return [
    ...
    'subscriptionPlans' => [
        ...
        'billing' => [
            ...
            'currency' => 'RWF :amount',
            'duration' => [
                'day' => '{1} umunsi :count|{2,*} iminsi :count',
                'month' => '{1} ukwezi :count|{2,*} amezi :count',
                'year' => '{1} umwaka :count|{2,*} imyaka :count',
                'hour' => '{1} isaha :count|{2,*} amasaha :count',
