    ...
    <div x-data="leaderboardTabs()" x-init="init()">
        ...
        @endauth
                ...
                <div class=" mt-6 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 py-4 p-6 backdrop-blur-sm">
                    <div class="flex items-end justify-center space-x-2 md:space-x-4">
                        ...
                        <div class="flex flex-col items-center group hover:transform hover:scale-105 transition-all duration-300">
                            <div class="relative">
                                <div class="w-14 h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-gray-400 to-gray-500 flex items-center justify-center text-white font-bold text-sm md:text-lg shadow-lg group-hover:shadow-xl transition-shadow">
                                    {{ substr($leaderboard[1]['user']['first_name'], 0, 1) }}{{ substr($leaderboard[1]['user']['last_name'], 0, 1) }}
                                </div>
                                <div class="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-6 h-6 md:w-8 md:h-8 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center shadow-md">
                            ...
                            <div class="mt-3 text-center">
                                <p class="text-sm font-medium text-gray-900 dark:text-white truncate max-w-[80px] md:max-w-[100px] group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors">
                        ...
                        <!-- 1st Place -->
                        <div class="flex flex-col items-center -mt-2 md:-mt-4 group hover:transform hover:scale-105 transition-all duration-300">
                            <div class="relative">
                                <div class="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-xl ring-2 md:ring-4 ring-yellow-200 dark:ring-yellow-800 group-hover:shadow-2xl transition-shadow">
                                    {{ substr($leaderboard[0]['user']['first_name'], 0, 1) }}{{ substr($leaderboard[0]['user']['last_name'], 0, 1) }}
                                </div>
                                <div class="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-7 h-7 md:w-10 md:h-10 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center shadow-md">
                            ...
                            <div class="mt-3 text-center">
                                <p class="text-sm font-medium text-gray-900 dark:text-white truncate max-w-[90px] md:max-w-[120px] group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors">
                        ...
                        <div class="flex flex-col items-center group hover:transform hover:scale-105 transition-all duration-300">
                            <div class="relative">
                                <div class="w-14 h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center text-white font-bold text-sm md:text-lg shadow-lg group-hover:shadow-xl transition-shadow">
                                    {{ substr($leaderboard[2]['user']['first_name'], 0, 1) }}{{ substr($leaderboard[2]['user']['last_name'], 0, 1) }}
                                </div>
                                <div class="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-6 h-6 md:w-8 md:h-8 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center shadow-md">
            ...
            @endif
                            ...
                            <!-- Rest of Leaderboard -->
                            <div class="mt-6 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden backdrop-blur-sm">
