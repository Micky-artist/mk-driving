    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 lg:py-8" x-data="forumTabs()">
        ...
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="flex-1 lg:flex-none lg:w-2/3 lg:mr-6">
                ...
                <div class="lg:hidden" x-show="activeTab === 'discussions'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                    ...
                    <div class="space-y-3">
                        @forelse($questions as $question)
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 hover:shadow-md transition-all duration-200" data-question-id="{{ $question['id'] }}">
                                <!-- Question Header with Voting -->
                                <div class="flex items-start space-x-3">
                                    <!-- Voting Column -->
                                    <div class="flex flex-col items-center space-y-1 flex-shrink-0">
                                        <button class="w-6 h-6 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-colors">
                                            <svg class="w-4 h-4 text-gray-400 hover:text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                            </svg>
                                        </button>
                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-300">0</span>
                                        <button class="w-6 h-6 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-colors">
                                            <svg class="w-4 h-4 text-gray-400 hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-400">
                                                <div class="flex items-center space-x-1">
                                                    <div class="w-5 h-5 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white text-xs font-bold">
                                        ...
                                        <div class="flex items-center space-x-4 text-xs">
                                            <button onclick="toggleCommentBox({{ $question['id'] }}, 'question')" class="flex items-center space-x-1 text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                            ...
                                            @if(count($question['answers']) > 0)
                                                <button class="flex items-center space-x-1 text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                                    </svg>
                                                    <span>{{ count($question['answers']) }} {{ count($question['answers']) == 1 ? 'Reply' : 'Replies' }}</span>
                                                </button>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 space-y-2">
                                        @foreach($question['answers'] as $answer)
                                            <div class="pl-4 border-l-2 border-gray-200 dark:border-gray-600">
                                                <!-- Answer with Voting -->
                                                <div class="flex items-start space-x-2" data-answer-id="{{ $answer['id'] }}" data-question-id="{{ $question['id'] }}">
                                                    <!-- Answer Voting -->
                                                    <div class="flex flex-col items-center space-y-1 flex-shrink-0">
                                                        <button class="w-5 h-5 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-colors">
                                                            <svg class="w-3 h-3 text-gray-400 hover:text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                                                        ...
                                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-300">0</span>
                                                        <button class="w-5 h-5 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-colors">
                                                            <svg class="w-3 h-3 text-gray-400 hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                                                                <path fill-rule="evenodd" d="M16.707 10.293a1 1 0 010 1.414l-6 6a1 1 0 01-1.414 0l-6-6a1 1 0 111.414-1.414L9 14.586V3a1 1 0 012 0v11.586l4.293-4.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                                            </svg>
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <div class="flex items-center space-x-2 mb-1">
                                                            <div class="w-4 h-4 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-white text-xs font-bold">
                                                        ...
                                                        <!-- Reply to Answer -->
                                                        <button onclick="toggleCommentBox({{ $answer['id'] }}, 'answer')" class="flex items-center space-x-1 text-xs text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                                        ...
                                                        <div id="comment-box-{{ $answer['id'] }}" class="hidden mt-3">
                                                            <form onsubmit="submitReply(event, {{ $answer['id'] }}, 'answer')">
                                                                @csrf
                                                                ...
                                                                <div class="mt-2 flex justify-end space-x-2">
                                                                    <button type="button" onclick="toggleCommentBox({{ $answer['id'] }}, 'answer')" class="px-3 py-1 text-xs font-medium text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors">
                                                                        Cancel
                                                                    </button>
                                                                    <button type="submit" class="px-3 py-1 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors">
                                                                        Post Reply
                                                                    </button>
                                                                </div>
                                                            </form>
                                ...
                                <div id="comment-box-{{ $question['id'] }}" class="hidden mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                                    <form onsubmit="submitReply(event, {{ $question['id'] }}, 'question')">
                                        ...
                                        <div class="mt-2 flex justify-end space-x-2">
                                            <button type="button" onclick="toggleCommentBox({{ $question['id'] }}, 'question')" class="px-3 py-1 text-xs font-medium text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors">
                                                Cancel
                                            </button>
                                            <button type="submit" class="px-3 py-1 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors">
                                                Post Answer
                        ...
                        @empty
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 text-center">
                                ...
                                <p class="text-gray-500 dark:text-gray-300 mb-4">{{ __('forum.no_questions') }}</p>
                ...
                <!-- Desktop Discussions Content (Always Visible) -->
                <div class="hidden lg:block">
                    ...
                    <div class="space-y-4">
                        @forelse($questions as $question)
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 hover:shadow-md transition-all duration-200" data-question-id="{{ $question['id'] }}">
                                <!-- Question Header with Voting -->
                                <div class="flex items-start space-x-4">
                                    <!-- Voting Column -->
                                    <div class="flex flex-col items-center space-y-2 flex-shrink-0">
                                        <button class="w-8 h-8 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-colors">
                                            <svg class="w-5 h-5 text-gray-400 hover:text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center space-x-6 text-sm">
                                            <button onclick="toggleCommentBox('desktop-{{ $question['id'] }}', 'question')" class="flex items-center space-x-2 text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                                </svg>
                                                <span>Reply</span>
                                            ...
                                            @if(count($question['answers']) > 0)
                                                <button class="flex items-center space-x-2 text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                                    </svg>
                                                    <span>{{ count($question['answers']) }} {{ count($question['answers']) == 1 ? 'Reply' : 'Replies' }}</span>
                                    ...
                                    <div class="mt-4 space-y-3">
                                        @foreach($question['answers'] as $answer)
                                            <div class="pl-6 border-l-2 border-gray-200 dark:border-gray-600">
                                                <!-- Answer with Voting -->
                                                <div class="flex items-start space-x-3" data-answer-id="{{ $answer['id'] }}" data-question-id="{{ $question['id'] }}">
                                                    <!-- Answer Voting -->
                                                    <div class="flex flex-col items-center space-y-1 flex-shrink-0">
                                                        <button class="w-6 h-6 rounded hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-colors">
                                                            <svg class="w-4 h-4 text-gray-400 hover:text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        ...
                                                        <!-- Reply to Answer -->
                                                        <button onclick="toggleCommentBox('desktop-{{ $answer['id'] }}', 'answer')" class="flex items-center space-x-2 text-sm text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                                            </svg>
                                                            <span>Reply</span>
                                                        ...
                                                        <!-- Reply Form (Hidden by default) -->
                                                        <div id="comment-box-desktop-{{ $answer['id'] }}" class="hidden mt-3">
                                                            <form onsubmit="submitReply(event, {{ $answer['id'] }}, 'answer')">
                                                                @csrf
                                                                <textarea name="content" rows="3" 
                                                                    ...
                                                                    placeholder="Write your reply..."></textarea>
                                                                <div class="mt-2 flex justify-end space-x-2">
                                                                    <button type="button" onclick="toggleCommentBox('desktop-{{ $answer['id'] }}', 'answer')" class="px-3 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors">
                                                                        Cancel
                                                                    </button>
                                                                    <button type="submit" class="px-3 py-1.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors">
                                                                        Post Reply
                                                                    </button>
                                                                </div>
                                                            </form>
                                ...
                                <!-- Reply Form for Question (Hidden by default) -->
                                <div id="comment-box-desktop-{{ $question['id'] }}" class="hidden mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                                    <form onsubmit="submitReply(event, {{ $question['id'] }}, 'question')">
                                        @csrf
                                        <textarea name="content" rows="3" 
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400" 
                                            placeholder="Write your answer..."></textarea>
                                        <div class="mt-2 flex justify-end space-x-2">
                                            <button type="button" onclick="toggleCommentBox('desktop-{{ $question['id'] }}', 'question')" class="px-3 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors">
                                                Cancel
                                            </button>
                                            <button type="submit" class="px-3 py-1.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors">
                                                Post Answer
                        ...
                        @empty
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
                                ...
                                <h3 class="text-xl font-medium text-gray-900 dark:text-white mb-2">{{ __('forum.no_questions_title') }}</h3>
                                <p class="text-gray-500 dark:text-gray-300 mb-6">{{ __('forum.no_questions') }}</p>
                                <a href="{{ route('forum.create', ['locale' => app()->getLocale()]) }}" 
