    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Create a new forum announcement</p>
                </div>
                <button type="button" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6">
                ...
                <form action="{{ route('admin.forum.announcement.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="content" 
                                  ...
                                  required
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white transition-colors duration-200"
                                  placeholder="Enter announcement content (minimum 10 characters)">{{ old('content') }}</textarea>
