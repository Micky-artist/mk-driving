...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="{{ route('password.reset', ['token' => $token, 'email' => $email, 'locale' => $locale]) }}" class="button">
        ...
        <div class="footer">
            <p>{{ __('auth.reset_password_email.ignore_if_not_requested', [], $locale) }}</p>
            <p>{{ __('auth.reset_password_email.contact_support', ['email' => config('mail.support_email')], $locale) }}</p>
