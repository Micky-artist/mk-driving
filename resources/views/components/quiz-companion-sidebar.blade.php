    ...
    <div
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-3">
            ...
            <template x-for="message in (robotMessages || [])" :key="message.id">
                <div
                    class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-3 transition-all duration-200 hover:shadow-sm">
            ...
            <template x-for="(user, index) in (leaderboard || [])" :key="user.id">
                <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-xs text-gray-500" x-text="user.points + ' ' + __('quiz.companion.points')">
                        </div>
                    </div>
