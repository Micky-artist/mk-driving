<div class="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-6 lg:px-0">
        @forelse($blogs ?? [] as $blog)
            <div class="bg-white dark:bg-gray-800/50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-200 h-full flex flex-col border border-gray-100 dark:border-gray-700/50">
        ...
        @empty
            <div class="col-span-3 text-center py-10">
                <p class="text-gray-500 dark:text-gray-400">{{ __('home.blogs.no_articles') }}</p>
            </div>
        @endforelse
    </div>
