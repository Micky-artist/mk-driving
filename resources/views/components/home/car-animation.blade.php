<div class="relative w-full h-full">
    <div class="relative w-full h-full">
        ...
        <div id="animation-container" class="relative w-full h-full overflow-hidden min-h-[400px] md:min-h-[500px]">
            
            <!-- Car Animation Container -->
            <div id="car-animation-container" class="absolute top-0 left-0 -mt-28 -ml-20 z-10 w-[500px] h-auto">
                <div id="car-animation" class="w-full h-full">
                    <!-- Car shadow -->
                    <div class="absolute -bottom-5 left-1/2 -translate-x-1/2 w-3/4 h-5 bg-black/10 dark:bg-black/20 rounded-full blur-sm"></div>
                </div>
            </div>

            <!-- Bike Animation Container -->
            <div id="bike-animation-container" class="absolute bottom-0 right-0 -mb-10 -mr-10 z-20 w-[500px] h-auto">
                ...
                const load = () => {
                    try {
                        animation = lottie.loadAnimation({
                            ...
                            path: path + (path.includes('?') ? '&' : '?') + 't=' + Date.now()
                        });
